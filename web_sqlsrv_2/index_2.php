...
<body>
    ...
    <div class="container-table">
        ...
        <div class="input-button">
            <button class="btn-export" onclick="window.open('export_excel_2.php')">Export Excel</button>
            <button class="btn-logout" name="submit"><a href="login_2.php">Logout</a></button>
        </div>
